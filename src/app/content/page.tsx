...
export default function ContentPage() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <motion.header
        className="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-8 py-4 sm:py-6 border-b border-border bg-background gap-2 sm:gap-0 shrink-0"
        variants={prefersReducedMotion ? undefined : fadeInUp}
      >
        <div>

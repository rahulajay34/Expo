...
LENGTH: Comprehensive but digestible — expand on complex ideas, summarize straightforward points, and avoid excessive detail that does not add value. Max lenghth ~2000 words.`,
